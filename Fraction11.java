public class Fraction11 { // дробь
    ...
    public Fraction11 sum(Fraction11 other) {
        ...
        return new Fraction11(newNumerator, newDenominator);
    }
    ...
    public Fraction11 sum(int number) {
        return this.sum(new Fraction11(number, 1));
    }

    public Fraction11 minus(int number) {
        return this.minus(new Fraction11(number, 1));
    }

    public Fraction11 multiply(int number) {
        return this.multiply(new Fraction11(number, 1));
    }

    public Fraction11 div(int number) {
        return this.div(new Fraction11(number, 1));
    }
